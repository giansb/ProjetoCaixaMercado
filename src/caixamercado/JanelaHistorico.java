...
public class JanelaHistorico extends javax.swing.JFrame {
    ...
    public JanelaHistorico() {
        ...
        for(Pedido p: lista){
            coluna[0] = String.valueOf(p.getId());
            coluna[1] = String.valueOf(p.getTipoPagamento());
            coluna[2] = String.valueOf(p.getCpf());
            coluna[3] = String.valueOf(p.getTotal());
            coluna[4] = String.valueOf(p.getData());
